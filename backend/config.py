...
AGENT_MODEL = "claude-opus-4-8"          # 破冰/标签抽取：主力模型
AGENT_MODEL_FAST = "claude-haiku-4-5"    # 聊天融洽度评分：高频、便宜

# ---- 偏好学习 ----
PREF_BONUS_MAX = 8.0                      # 学到的偏好在 rank_score 上的加分上限
PREF_LEARNING_RATE = 0.35                 # 每次聊天对 tag 权重的学习率
